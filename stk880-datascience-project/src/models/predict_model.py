...
def main(logging):
    ...
    model = load_model('models/stk880_model_v1.h5')
    ...
    plot_confusion_matrix(cm = conf_matrix, normalize=True, target_names = ['0', '1'],
                          filepath='reports/figures/confusion_matrix.png')
